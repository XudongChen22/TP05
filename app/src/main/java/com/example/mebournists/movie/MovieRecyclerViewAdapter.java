...
import com.example.mebournists.movie.MovieFragment.OnListFragmentInteractionListener;
...
public class MovieRecyclerViewAdapter
  ...
  public static class ViewHolder extends RecyclerView.ViewHolder {
    ...
    public final CheckBox movieSwitch;
    ...
    public ViewHolder(View view, OnListFragmentInteractionListener listener) {
      super(view);
      this.view = view;
      this.movieSwitch = (CheckBox) view.findViewById(R.id.movie_switch);
